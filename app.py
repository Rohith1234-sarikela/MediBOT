...
def helper(disease):
    ...
    med = med if med else ["Consult a doctor for medications."]
...
def predict():
    if request.method == "POST":
        ...
        predicted_disease, error = get_predicted(user_symptoms)
        
        if error or not predicted_disease:
            return render_template("index.html", error=error or "Unable to predict disease.")
